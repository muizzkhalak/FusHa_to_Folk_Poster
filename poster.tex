...
% \institute[shortlist]{ Department of Advanced Computing Sciences }
...
% \logoright{\includegraphics[height=4cm]{logos/VOXReality-logo.png}}
\logoleft{\hspace{3ex}\includegraphics[height=3.5cm]{logos/maastricht_logo.svg.png}}
